  ...
  const teamMembers = [
    {
      ...
      pronouns: 'he/him',
      description: 'Led the frontend development with React and Tailwind CSS—crafted responsive, accessible, and visually engaging interfaces that blend design with seamless user interaction.',
      skills: ['React', 'Javascript', 'Tailwind CSS', 'Node.js', 'Express.js','MongoDB', 'Database Design', 'API Integration', 'Three.js', 'Figma'],
      photo: himesh,
